			 ...
			 <h2 style="margin-bottom:15px;"><?php _e('Floating bubble options', 'adhs'); ?></h2>
				 ...
				 <label for="animationin">
				  <h3><?php _e('Animation in', 'adhs'); ?></h3>
					...
					<select name="animationin" id="animationin">
						<option value="drop"<?php echo get_option('animationin'); ?>>drop</option>
						<option value="bubble"<?php echo get_option('animationin'); ?>>bubble</option>
						<option value="fade"<?php echo get_option('animationin'); ?>>fade</option>
					</select>
                 </label>
				 <label for="animationout">
					...
					<select name="animationout" id="animationout">
						<option value="drop"<?php echo get_option('animationout'); ?>>drop</option>
						<option value="bubble"<?php echo get_option('animationout'); ?>>bubble</option>
						<option value="fade"<?php echo get_option('animationout'); ?>>fade</option>
					</select>
                 </label>
				...
				<h3><?php _e('On which page the balloon should appear?', 'adhs'); ?></h3>
					...
					<select name="pagetarget" id="pagetarget">
						<option value="homeonly"<?php echo get_option('pagetarget'); ?>><?php _e('Home only', 'adhs'); ?></option>
						<option value="allpages"<?php echo get_option('pagetarget'); ?>><?php _e('All pages', 'adhs'); ?></option>
					</select>
                </label>
             </td>
		   </tr>
